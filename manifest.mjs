...
fs.writeFileSync(path.join(root,'MANIFEST.json'),JSON.stringify({product:'WebVideo+',version:'0.4.10',kernelVersion:'0.3.15-internal',files},null,2));console.log('Package manifest: '+files.length+' files');
