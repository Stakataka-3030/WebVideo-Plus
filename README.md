...
**当前源码版本：1.0.0（内部开发标识 0.6.3；安装器 Win32 版本 1.0.0.0，导出内核 0.5.5）。** 最新正式安装器、校验值和发布说明以 [GitHub Releases](https://github.com/Stakataka-3030/WebVideo-Plus/releases/latest) 为准。
