...
[下载安装器](https://github.com/Stakataka-3030/WebVideo-Plus/releases/latest) · [1.0.3 发行说明](RELEASE_NOTES_1.0.3.md) · [版本记录](CHANGELOG.md) · [构建说明](BUILDING.md) · [MPL-2.0](LICENSE) · [许可范围](LICENSES.md) · [来源与许可](NOTICE.md)

**当前源码版本：1.0.3（内部开发标识 0.8.2；安装器 Win32 版本 1.0.3.0，导出内核 0.6.43）。** 最新正式安装器、校验值和发布说明以 [GitHub Releases](https://github.com/Stakataka-3030/WebVideo-Plus/releases/latest) 为准。
...
1.0.3 的发布摘要见 [1.0.3 发行说明](RELEASE_NOTES_1.0.3.md)；此前版本见 [1.0.2 发行说明](RELEASE_NOTES_1.0.2.md)、[1.0.1 发行说明](RELEASE_NOTES_1.0.1.md)与[1.0.0 发行说明](RELEASE_NOTES_1.0.0.md)，完整细节见 [版本记录](CHANGELOG.md)。
