...
- 构建期生命周期回归新增 Cubism 3/4 queue 秒制 rebase、loop phase、deterministic blink、expression/blink/focus epoch metadata 与 renderer hook 检查。pipeline revision 更新为 `cubism34-seam-timeline-0.8.1`，旧分片缓存自动失效。
