...
winrt::com_ptr<ID3D11Device> CreateDevice(){winrt::com_ptr<ID3D11Device> device;UINT flags=D3D11_CREATE_DEVICE_BGRA_SUPPORT;HRESULT hr=D3D11CreateDevice(nullptr,D3D_DRIVER_TYPE_HARDWARE,nullptr,flags,nullptr,0,D3D11_SDK_VERSION,device.put(),nullptr,nullptr);if(hr==DXGI_ERROR_UNSUPPORTED)hr=D3D11CreateDevice(nullptr,D3D_DRIVER_TYPE_WARP,nullptr,flags,nullptr,0,D3D11_SDK_VERSION,device.put(),nullptr,nullptr);check_hresult(hr);return device;}
...
public:
 ...
 std::string Ready(){auto size=item_.Size();std::ostringstream o;o<<"{\"adapter\":"<<Json(AdapterName(device_))<<",\"width\":"<<size.Width<<",\"height\":"<<size.Height<<",\"dpi\":"<<GetDpiForWindow(hwnd_)<<"}";return o.str();}
