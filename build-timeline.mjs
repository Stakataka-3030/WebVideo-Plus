...
const patches=[
  ...
  {scopeStart:'function GraphicalEditor(_e){',scopeEnd:'jsxRuntimeExports.jsx(EditorSideBar,{})',regex:'eventBus\\.emit\\("editor:update-scene",\\{scene:[A-Za-z_$][A-Za-z0-9_$]*\\}\\)',replace:'wvpLoaded.current=true,$&'},
...
for(const p of patches){
  ...
  if(matches.length!==1)throw Error('Timeline scoped anchor must be unique: '+p.regex);
}
